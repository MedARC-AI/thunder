...
from .patch_camelyon import create_splits_patch_camelyon, download_patch_camelyon
from .segpath_epithelial import (
    create_splits_segpath_epithelial,
    download_segpath_epithelial,
)
from .segpath_lymphocytes import (
...
from .spider_colorectal import (
    create_splits_spider_colorectal,
    download_spider_colorectal,
)
